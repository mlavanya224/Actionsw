...
INSERT INTO `categories` (`id`, `cid`, `categories_name`) VALUES
(5, 4, 'fbgfb gfb'),
(1, 3, 'Mobile');
...
CREATE TABLE `ilance_buynow_orders` (
  ...
  `ship_location` mediumtext DEFAULT NULL,
  ...
  `winnermarkedaspaidmethod` mediumtext DEFAULT NULL,
...
CREATE TABLE `ilance_projects` (
  ...
  `description_videourl` mediumtext DEFAULT NULL,
  ...
  `paymethod` mediumtext DEFAULT NULL,
  `paymethodcc` mediumtext DEFAULT NULL,
  `paymethodoptions` mediumtext DEFAULT NULL,
  `paymethodoptionsemail` mediumtext DEFAULT NULL,
  ...
  `returnpolicy` mediumtext DEFAULT NULL,
  `buyerfeedback` int(1) NOT NULL DEFAULT 0,
  `sellerfeedback` int(1) NOT NULL DEFAULT 0,
  ...
  `itemcondition` mediumtext DEFAULT NULL,
...
CREATE TABLE `ilance_users` (
  ...
  `date_added` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `subcategories` mediumtext DEFAULT NULL,
  ...
  `notifyservicescats` mediumtext DEFAULT NULL,
  `notifyproductscats` mediumtext DEFAULT NULL,
  ...
  `searchoptions` mediumtext DEFAULT NULL,
  `rateperhour` double(10,2) NOT NULL DEFAULT 0.00,
  `profilevideourl` mediumtext DEFAULT NULL,
  `profileintro` mediumtext DEFAULT NULL,
  ...
  `username_history` mediumtext DEFAULT NULL,
